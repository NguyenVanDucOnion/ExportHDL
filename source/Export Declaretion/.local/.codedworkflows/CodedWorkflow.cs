...
namespace ExportDeclaretion
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        private Lazy<global::ExportDeclaretion.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::ExportDeclaretion.WorkflowRunnerService>(() => new global::ExportDeclaretion.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::ExportDeclaretion.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
